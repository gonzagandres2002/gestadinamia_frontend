...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#08180e] px-6 py-16 text-white lg:px-10">
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-[radial-gradient(70%_50%_at_85%_15%,rgba(28,143,62,0.14),transparent_60%)]"
      />
            ...
            <div className="mt-6 flex items-center gap-2">
              {socials.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/15 bg-white/5 text-white/70 transition-colors hover:bg-white/10 hover:text-white"
                >
